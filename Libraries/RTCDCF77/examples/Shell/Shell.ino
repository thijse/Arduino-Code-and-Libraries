...
int addressRamTime;      // memory adress in NVRAM of timestamp
int addressStoreCounter; // memory adress in NVRAM of storage counter

/*** Start defining the shell commands ***/
...
/*** End defining the shell commands ***/
...
{    
   time_t  RamTime; // timestamp stored in RAM
