...
//------------------------------------------------------------------------------
const bool MISO_MODE  = false;  // input mode
const bool MISO_LEVEL = false;  // pullup disabled
const bool MOSI_MODE  = true;   // output mode
const bool SCK_MODE   = true;   // output mode
//------------------------------------------------------------------------------
/**
 * \class SoftSPI
